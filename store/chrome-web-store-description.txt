...
• Works offline once your location is saved

📖 DAILY QURAN & HADITH
• Beautiful daily Ayah with Arabic text, transliteration, and English translation - a different verse every day
• Curated authentic Hadith of the Day with source attribution
• Premium Arabic typography (Amiri font) for an elegant reading experience

📿 ADHKAR PLAYER
• Complete morning and evening Adhkar sessions with Arabic text, transliteration, translation, and recommended count
• Progress tracking with visual progress bar - sessions persist per day and auto-reset
• Optional Fajr (morning) and Asr (evening) Adhkar reminders
...
🌙 FASTING TRACKER
• Ramadan Mode with live countdown to Suhoor and Iftar (seconds precision)
• Mark each day as fasted, not fasted, or excused
• Sunnah fast support (Mondays, Thursdays, Ayyam al-Bidh)
• Monthly fasting calendar with colour-coded status
...
• Arabic calligraphy, transliteration, meaning, and devotional benefit
• Full-screen searchable grid of all 99 names

🌍 GLOBAL PRAYER TIMES
• Prayer times for Makkah and Madinah always visible
• Add up to 3 custom cities from 500+ worldwide locations
...
• Set personal goals (33, 99, 100+) with visual progress tracking
• Persistent - counts survive browser restarts

🔇 FOCUS MODE
• Silence all prayer reminders for 1, 2, or 4 hours
